// src/store/useExecutionStore.js
...
export const useExecutionStore = create((set) => ({
  ...
  submitSolutionCode: async (source_code, language_id, stdin, expected_outputs, problemId) => {
    try {
      set({ isExecuting: true });
      console.log("Submission:-----------", JSON.stringify({
        source_code,
      ...
      const res = await axiosInstance.post("/execute-code/submit-solution", { source_code, language_id, stdin, expected_outputs, problemId });
